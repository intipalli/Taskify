         ...
         <div id="content">
            ...
            <div class="container-fluid">
               ...
               <!--       <div class="text-primary h6">
                  ...
                  <span id="reportrange" class="p-1 border border-secondary form-control" style="cursor: pointer;"></span>
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               ...
               <div class="home" style="cursor: default;">
                  ...
                  <div class="pt-2">
                     ...
                     <div class="input-group mb-3 w-25 pt-2 ">
                        <span id="reportrange" class="form-control" style="cursor: pointer;"></span>
                        <button onclick="getTasks();initialise();" class="btn btn-sm btn-success">Fetch</button>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="row">
                        <div class="col-lg-12">
                           <div class="table-responsive">
                              <table id="sample_7" style="width:100%;" class="bg-light table table-bordered table-hover table-sm mb-0 text-center">
                                 <thead>
                                    <tr>
      ...
      <script type="text/javascript">
         $(function() {
           ...
           function cb(start, end) {
             $('#reportrange').html(start.format('MM/DD/YYYY') + ' to ' + end.format('MM/DD/YYYY'));
           }
