...
<html>
   ...
   <body >
         ...
         <div class="row justify-content-center" style="margin-top:14%;">
            <div class="col-md-6 col-lg-4">
               ...
               <form>
                  ...
                  <div class="form-group">
                     <button type="button" onclick="resetPassword()" class="btn btn-sm btn-success px-5">Reset</button>
                  </div>
               </form>
            </div>
         </div>
      ...
      <script>
               ...
               $.ajax({
                 ...
                 success: function(data) {
                   if (data != '') {
                     ...
                     toastr.options.closeButton = true;
                     toastr.options.positionClass = 'toast-top-center';
                      toastr.success('Password reset successfully, you will be redirected to login page', ' Success');
                     $("#password").val("");
                     $("#confirmPassword").val("");
         ...
         function fun(){
             window.location.href = "http://localhost:8081/tms/login";
