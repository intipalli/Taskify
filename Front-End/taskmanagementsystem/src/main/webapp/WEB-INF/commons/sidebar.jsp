   ...
   <body>
      <nav id="sidebar" class="active">
         ...
         <ul class="list-unstyled components" id="sbcontent">
            ...
            <li>
               <a name="#sprintSubmenu" onmousedown="mouseDown(event,this);" onmouseover="over(this)" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> <i class="fas fa-clock"></i> Sprint
               </a>
            ...
            <li>
               <a name="#taskSubmenu" onmousedown="mouseDown(event,this);" onmouseover="over(this)" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> <i class="fas fa-tasks"></i> Task
               </a>
            ...
            <li>
               <a name="#settingsSubmenu" onmousedown="mouseDown(event,this);" onmouseover="over(this)" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> <i class="fas fa-cog"></i> Settings
               </a>
