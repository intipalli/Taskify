  ...
  <div class="wrapper">
    ...
    <div id="content" class="active">
      ...
      <div class="container-fluid">
        <h3 class="text-success">Welcome back, ${fullName}</h3>
        <br>
        <h5 class="text-primary text-center h4">Pending Tasks</h5>
 ...
 <script src="${pageContext.request.contextPath}/resources/js/jquery-3.6.0.min.js"></script>
   ...
   <script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      $("#excelDownload").click(function() {
        ...
        var SS = d.getSeconds();
        var filename = "Pending tasks " + DD + MM + YYYY + "_" + HH + "_" + MIN + "_" + SS + ".xlsx";
  ...
  <script>
        ...
        success: function(data) {
          if (data != null) {
            ...
            for (var i = 0; i < arr.length; i++) {
              var response = arr[i];
              if(response.currentTaskStatus == "In Progress"){
                ...
                tableContent +=
                    '<button type="button" name="' + response.id + ",Completed" + '" onclick="updateCurrentTaskStatus(this)" class="btn btn-sm" data-toggle="tooltip" data-placement="top" title="Mark As Complete">' +
            ...
            for (var i = 0; i < tags.length; i++) {
              if (tags[i].innerHTML == "In Progress") {
    ...
    function updateCurrentTaskStatus(a) {
        var taskId = a.getAttribute("name").split(",")[0];
        var st = a.getAttribute("name").split(",")[1];
        var comment = "";
        if(st == "Completed"){
