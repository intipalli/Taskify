    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <header class="py-4 text-center">
            <h5 class="text-success" id="sprintName"></h5><br>
            <h6 class="text-primary" id="sprintDetails"></h6><br><br>
      ...
      $.ajax({
        ...
        success: function(data) {
          if (data != null) {
            ...
            $("#sprintDetails").html((res.startDate).split(" ")[0] + " - " + (res.actualEndDate != undefined ? res.actualEndDate.split(" ")[0] : res.endDate.split(" ")[0]) + "&nbsp;&nbsp;&nbsp;<i class='fas fa-circle text-muted'></i>&nbsp;&nbsp;&nbsp;" + ( res.duration+1 == 1 ? "1 day" : res.duration+1 + " days" ) + "&nbsp;&nbsp;&nbsp;<i class='fas fa-circle text-muted'></i>&nbsp;&nbsp;&nbsp;" + res.currentSprintStatus);
