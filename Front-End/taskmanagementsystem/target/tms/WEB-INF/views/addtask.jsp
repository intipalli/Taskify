              ...
              <div class="card">
                ...
                <div class="card-body">
                  <form id="addTaskForm" class="form-horizontal">
                    ...
                    <div class="border-bottom my-5 border-gray-200"></div>
                    <div class="row">
                      <label class="col-sm-3 form-label"><span class="text-danger">*</span> Estimated Time Of Delivery In Mins (Enter number)</label>
                      <div class="col-sm-9">
                        ...
                        <div id="timeFeedback" class="invalid-feedback">
                          Please provide a estimated time in mins.
                        </div>
                      </div>
                    </div>
                    <div class="border-bottom my-5 border-gray-200"></div>
