 ...
 <input type="text" class="form-control" onkeydown="return false;" onpaste="return false;" value="" id="reportrange" autocomplete="off">
        ...
        <header class="py-4 text-center">
          <div class="btn-group">
            ...
            <button type="button" id="ongoingBtn" onclick="showOngoing(this)" class="btn btn-warning">Ongoing</button>
    ...
    $(document).ready(function() {
    	...
    	$('input[name="datefilter1"]').daterangepicker({
    	      ...
    	      minDate:new Date()
       	      ...
       	      $("#sprintStartDate").val(start.format('DD/MM/YYYY'));
      	  ...
      	  $('input[name="datefilter2"]').daterangepicker({
    	      ...
    	      drops: 'up'
      		      ...
      		      $("#sprintEndDate").val(end.format('DD/MM/YYYY'));
...
$(function() {
  ...
  <script>
    ...
    function getSprints() {
      ...
      $("#ongoingBtn").attr("class", "btn btn-warning");
            ...
            for (var i = 0; i < arr.length; i++) {
              var response = arr[i];
                tableContent += "<tr class='" + response.currentSprintStatus + "'><td style='display:none'>" + response.sprintId +
                  ...
                  "<td name='ed'>" + (response.actualEndDate != undefined ? (response.actualEndDate).split(" ")[0] : "-") + "</td>" +

                  "<td>" + (response.duration+1 == 1 ? "1 day" : response.duration+1 + " days"  ) + "</td>" +
                  "<td>" + (response.actualTimeTaken != undefined ? (parseInt(response.actualTimeTaken)+1 == 01 ? "1 day" : parseInt(response.actualTimeTaken)+1 + " days"  ) : "-") + "</td>" +
